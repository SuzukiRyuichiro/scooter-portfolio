...
projects = [
  ...
  { project_name: "twitter", content: "<b>Twitter Clone</b> is a static webpage built with Vue.js and tailwindcss. This project was aimed to get myself comfortable with the Vue framework and tailwindcss. I love both Vue and tailwind on how intuitive and flexible they are to make interactive and responsive websites! <a href='https://suzukiryuichiro.github.io/clone-twitter'><i class='fas fa-desktop'></i></a> <a href='https://github.com/SuzukiRyuichiro/clone-twitter'><i class='fab fa-github'></i></a>" }
]

projects.each do |app|
  proxy "/projects/#{app[:project_name]}.html", "/projects/template.html", :locals => app, :ignore => true
end
